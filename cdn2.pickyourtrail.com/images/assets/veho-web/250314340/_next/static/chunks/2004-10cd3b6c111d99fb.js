            ...
            t.createReactPlayer = function(e, t) {
                ...
                return s = r = function(r) {
                    ...
                    function j() {
                        ...
                        return O(P(r = w.call.apply(w, [this].concat(s))), "state", {
                    ...
                    return p = [{
                        ...
                        value: function() {
                            ...
                            }, c), n.default.createElement(D, {
                                fallback: i
                            }, l ? this.renderPreview(t) : this.renderActivePlayer(t)))
                        }
                    }], v(j.prototype, p), b && v(j, b), j
                }(n.Component), O(r, "displayName", "ReactPlayer"), O(r, "propTypes", u.propTypes), O(r, "defaultProps", u.defaultProps), O(r, "addCustomPlayer", function(e) {
                    R.push(e)
        ...
        73911: function(e, t, r) {
            ...
            var y = function(e) {
                ...
                function y() {
                    ...
                    for (var t = arguments.length, r = Array(t), n = 0; n < t; n++) r[n] = arguments[n];
                    return p(s(e = u.call.apply(u, [this].concat(r))), "callPlayer", a.callPlayer), p(s(e), "duration", null), p(s(e), "currentTime", null), p(s(e), "secondsLoaded", null), p(s(e), "mute", function() {
                        e.callPlayer("mute")
        ...
        50993: function(e, t, r) {
            ...
            var y = function(e) {
                ...
                function d() {
                    ...
                    for (var t = arguments.length, r = Array(t), n = 0; n < t; n++) r[n] = arguments[n];
                    return p(s(e = y.call.apply(y, [this].concat(r))), "callPlayer", a.callPlayer), p(s(e), "duration", null), p(s(e), "currentTime", null), p(s(e), "secondsLoaded", null), p(s(e), "mute", function() {
                        e.callPlayer("mute")
                    }), p(s(e), "unmute", function() {
                        e.callPlayer("unmute")
                    }), p(s(e), "ref", function(t) {
                ...
                return r = [{
                    ...
                    value: function(e) {
                        ...
                        (0, a.getSDK)("https://fast.wistia.com/assets/external/E-v1.js", "Wistia").then(function(e) {
                            c.customControls && c.customControls.forEach(function(t) {
            ...
            var v = /[?&](?:list|channel)=([a-zA-Z0-9_-]+)/,
                ...
                g = function(e) {
                    ...
                    function f() {
                        ...
                        for (var t = arguments.length, r = Array(t), n = 0; n < t; n++) r[n] = arguments[n];
                        return b(d(e = l.call.apply(l, [this].concat(r))), "callPlayer", a.callPlayer), b(d(e), "parsePlaylist", function(t) {
