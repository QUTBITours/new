window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "record_targeting_rules": [{
        ...
        "pattern": "https://pickyourtrail.com/vacations/maldives",
        "negate": false
    }, {
        "component": "url",
        "match_operation": "starts_with",
        "pattern": "https://pickyourtrail.com/vacations/bali",
        "negate": false
    }, {
        "component": "url",
        "match_operation": "starts_with",
        "pattern": "https://pickyourtrail.com/vacations/thailand",
        "negate": false
    }, {
        "component": "url",
        "match_operation": "starts_with",
        "pattern": "https://pickyourtrail.com/packages/maldives",
        "negate": false
    }, {
        "component": "url",
        "match_operation": "starts_with",
        "pattern": "https://pickyourtrail.com/packages/bali",
        "negate": false
    }, {
        "component": "url",
        "match_operation": "starts_with",
        "pattern": "https://pickyourtrail.com/packages/thailand",
        "negate": false
    }, {
        "component": "url",
        "match_operation": "starts_with",
        "pattern": "https://pickyourtrail.com/packages/europe",
        "negate": false
    }, {
        "component": "url",
        "match_operation": "starts_with",
        "pattern": "https://pickyourtrail.com/vacations/europe",
        "negate": false
    }, {
        "component": "url",
        "match_operation": "simple",
        "pattern": "https://pickyourtrail.com/",
        "negate": false
    }, {
        "component": "url",
        "match_operation": "simple",
        "pattern": "https://pickyourtrail.com/partners/oh_yes_honeymooon_deals",
        "negate": false
    }],
    "feedback_widgets": [],
    "heatmaps": [],
    ...
    "features": ["client_script.compression.pc", "tcvs_v2", "survey.embeddable_widget", "feedback.widget_telemetry", "survey.screenshots", "csq_theme", "ask.popover_redesign", "error_reporting", "feedback.widgetV2", "settings.billing_v2", "survey.image_question", "feedback.embeddable_widget", "survey.type_button"],
    "tracking_code_verified": true,
    "cs_project_id": null,
    "account_id": 50686,
    "account_signature": "af1b0162213c3b2f5fb9aa4118edbae8ca19b2be6f7f698675c0975d6f8f13d9"
};
...
! function() {
    ...
    if (window.hjLazyModules = window.hjLazyModules || {
            SURVEY_V2: {
                js: "survey-v2.35391c28507202aa6f40.js"
            },
            SURVEY_BOOTSTRAPPER: {
            ...
            USER_TEST: {
                js: "user-test.bd26e6668c858939edf3.js"
            }
        ...
        d.async = 1, d.src = hj.scriptDomain + t, d.charset = "utf-8", l.appendChild(d), u.revision = "b2c7a36", window.hjBootstrap = u
    }, window.hjBootstrap("https://script.hotjar.com/", "modules.ef5986d046c68a8c77c1.js", "81935"), hj.metrics.timeEnd("resource-blocking-time", {
        tag: {
            resource: "hotjar-js"
        },
        start: Y,
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
            n = (new Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "0ff31a6d-6764-56a5-b5f6-a41f0ad3c822")
    } catch (e) {}
}();
//# debugId=0ff31a6d-6764-56a5-b5f6-a41f0ad3c822